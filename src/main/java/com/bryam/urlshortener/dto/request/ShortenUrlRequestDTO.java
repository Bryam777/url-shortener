...
public class ShortenUrlRequestDTO {
    ...
    @Pattern(regexp = "^(https?://).+", message = "URL must start with http:// or https://") // Validación del formato
    private String originalUrlRequest;

    // Validaciones para el dominio personalizado, para usuarios registrados
    @Size(max = 50, message = "The custom slug cannot exceed 50 characters") // Máximo 50 caracteres para el dominio
